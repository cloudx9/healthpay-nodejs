...
export declare type GqlRequest = {
    gql: string;
    operation: string;
    variables: {
        [key: string]: unknown;
...
export declare type BackendBodyResponse = any;
...
export declare type ClientStatus = "CONNECTED" | "PENDING" | "DISCONNECTED";
...
export declare type EventType = keyof typeof CLIENT_EVENTS;
export {};
