...
var HttpRequests = /** @class */ (function () {
    ...
    HttpRequests.prototype.request = function (body, headers) {
        return new Promise(function (resolve, reject) {
            var fullHeaders = __assign(__assign({}, headers), { "content-type": "application/json" });
    ...
    HttpRequests.prototype.gqlRequest = function (gqlRequestData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.request(body, gqlRequestData.headers)];
                    case 2:
                        resp = _a.sent();
                    ...
                    case 3:
                        ...
                        if (e_1.length > 0 && e_1[0].message) {
                            throw new Error(e_1[0].message);
                        }
                        else {
                            throw new Error("Something went wrong " + e_1.getMessage());
                        }
                        return [3 /*break*/, 4];
